...
class refined_unit_tests(BaseModel):
    new_unit_test_code: str = Field(description="The new unit test code. Make sure it is valid C# code without ```csharp tags. Make sure that there are no line numbers in the  result code.")
